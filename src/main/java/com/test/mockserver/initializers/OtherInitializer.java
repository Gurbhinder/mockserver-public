...
public class OtherInitializer implements ExpectationInitializer {
                ...
                for (Object object : yaml.loadAll(inputStream)) {
                    if (object instanceof RequestAndResponse) {
                        ...
                        HttpRequest httpRequest = request().withMethod(rpObj.getRequest().getMethod())
                                ...
                                .withBody(ConvertInternalToMockObjects.mockBodyMatching(rpObj.getRequest().getRequestBody()))
